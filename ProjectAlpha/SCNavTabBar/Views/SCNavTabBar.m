...
- (void)themeColorUpdate:(NSNotification *)notification
{
    ...
    self.backgroundColor = notification.userInfo[@"normal"];
...
- (void)dayMode:(NSNotification *)notification
{
    ...
    if ([userDefaults colorForKey:@"normal"]) {
         self.backgroundColor = [userDefaults colorForKey:@"normal"];
        
    }else {
    
        self.backgroundColor = [UIColor colorWithRed:0.3294 green:0.7647 blue:0.9451 alpha:1.0];
    }
